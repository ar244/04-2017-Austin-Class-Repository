# 23.2 Lesson Plan - First Steps with Java
...
* Slack out the `05-Console-IO-Java/Unsolved/console/ConsoleIO.java` file to students. It contains instructions, so you don't need to slack these out separately.
